...
test('page versions critical assets and loads price-alert utilities before the application', () => {
  ...
  assert.deepEqual(criticalAssets, [
    './style.css?v=20260808-trend10',
    './chart-time-utils.js?v=20260808-trend10',
    './price-alert-utils.js?v=20260808-trend10',
    './app.js?v=20260808-trend10'
  ]);

  const priceAlertIndex = html.indexOf('./price-alert-utils.js?v=20260808-trend10');
  const appIndex = html.indexOf('./app.js?v=20260808-trend10');
