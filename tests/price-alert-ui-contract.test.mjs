...
test('page versions critical assets and loads price-alert utilities before the application', () => {
  ...
  assert.deepEqual(criticalAssets, [
    './style.css?v=20260808-trend15',
    './chart-time-utils.js?v=20260808-trend15',
    './price-alert-utils.js?v=20260808-trend15',
    './app.js?v=20260808-trend15'
  ]);

  const priceAlertIndex = html.indexOf('./price-alert-utils.js?v=20260808-trend15');
  const appIndex = html.indexOf('./app.js?v=20260808-trend15');
